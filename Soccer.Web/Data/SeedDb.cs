...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Omar", "Vera", "omarap4@hotmail.com", "313 727 8796", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("2020", "Omar", "Vera", "omarap4@gmail.com", "313 727 8796", "Calle Luna Calle Sol", UserType.User);
